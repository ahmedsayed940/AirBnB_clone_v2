...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not kwargs:
            ...
            self.created_at = Column(DateTime, nullable=False, default=func.utcnow())
            #self.updated_at = datetime.now()
            self.updated_at = Column(DateTime, nullable=False, default=func.utcnow(), onupdate=func.utcnow())
        else:
            ...
            # Set instance attribute if not already set
